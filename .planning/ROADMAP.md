...
- [ ] 06-03-PLAN.md — Gap closure: OutputsPanel guard phaseId<=7→removed (phases 8+9 get SWR artifact links); AlertDialogAction→AlertDialogPrimitive.Close (dialog auto-closes on confirm)
