...
export function AppShell({ children, phaseId, gateId }: AppShellProps) {
  return (
    <div className="min-h-screen flex flex-col bg-[var(--color-background)]">
      {/* Top bar */}
      <header className="h-12 border-b border-[var(--color-border)] bg-[var(--color-surface)] flex items-center px-4 gap-3 flex-shrink-0">
      ...
      {/* Phase stepper — persistent journey indicator */}
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <main className="flex-1 flex flex-col overflow-auto">
          {/* Breadcrumb — contextual, no product prefix */}
