...
export async function GET() {
  ...
  // SI-07: Include seeded findings prominently (MOP-012 torque variation — Observation, non-blocking)
  ...
  return NextResponse.json({
    ...
    seededFindings, // SI-07 MOP-012 torque variation prominently surfaced
    deterministicChecks: [], // Phase 7 uses no deterministic checks (lessons-learned is AI-driven)
