...
export async function POST(req: NextRequest) {
  // GR-02: Human-only gate decision — AI actor prohibition (T-05-09 mitigation)
  ...
  try {
    ...
    // Compact phase 7 summary (LC-08: Gate 7 Pass in happy path)
    await db.update(phaseStates).set({
      compactPhaseSummary: {
        ...
        approvedOutputs: ['Structured Lessons-Learned Register', 'Transfer-Completeness and Improvement-Action Report'],
