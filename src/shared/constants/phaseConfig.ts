export const PHASE_CONFIG = [
  {
    phaseId: 0, phaseName: 'Project Initiation',
  ...
  {
    phaseId: 1, phaseName: 'Concept & Proposal',
    technicalReview: 'SLR',
  ...
  {
    phaseId: 2, phaseName: 'Requirements Development',
  ...
  {
    phaseId: 4, phaseName: 'Detail Design',
  ...
  {
    phaseId: 5, phaseName: 'Design Validation',
    technicalReview: null,
  ...
  {
    phaseId: 6, phaseName: 'Production Preparation & Qualification',
    technicalReview: null,
  ...
  {
    phaseId: 7, phaseName: 'Transfer & Monitor',
    technicalReview: null,
  ...
  {
    phaseId: 8, phaseName: 'Manufacture',
    technicalReview: null,
